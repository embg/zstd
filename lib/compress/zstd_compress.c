...
ZSTD_bounds ZSTD_cParam_getBounds(ZSTD_cParameter param)
{
    ...
    case ZSTD_c_fastExternalSequenceParsing:
        bounds.lowerBound = (int)ZSTD_ps_auto;
        bounds.upperBound = (int)ZSTD_ps_disable;
        return bounds;
                                    ...
                                    ZSTD_cParameter param, int value)
{
    ...
    case ZSTD_c_fastExternalSequenceParsing:
        BOUNDCHECK(ZSTD_c_fastExternalSequenceParsing, value);
        CCtxParams->fastExternalSequenceParsing = (ZSTD_paramSwitch_e)value;
        return CCtxParams->fastExternalSequenceParsing;
        ...
        ZSTD_CCtx_params const* CCtxParams, ZSTD_cParameter param, int* value)
{
    ...
    case ZSTD_c_maxBlockSize:
        *value = (int)CCtxParams->maxBlockSize;
        break;
    case ZSTD_c_fastExternalSequenceParsing:
        *value = (int)CCtxParams->fastExternalSequenceParsing;
        break;
    default: RETURN_ERROR(parameter_unsupported, "unknown parameter");
    }
    return 0;
                ...
                if (!ZSTD_isError(nbPostProcessedSeqs)) {
                    ...
                    FORWARD_IF_ERROR(
                        ZSTD_copySequencesToSeqStoreExplicitBlockDelim(
                            ...
                            src, srcSize,
                            zc->appliedParams.fastExternalSequenceParsing
                        ),
...
ZSTD_copySequencesToSeqStoreExplicitBlockDelim(ZSTD_CCtx* cctx,
                                        ...
                                        const void* src, size_t blockSize, ZSTD_paramSwitch_e parseFast)
{
    U32 idx = seqPos->idx;
                          ...
                          const void* src, size_t srcSize)
{
    ...
    while (remaining) {
        ...
        additionalByteAdjustment = sequenceCopier(cctx, &seqPos, inSeqs, inSeqsSize, ip, blockSize, cctx->appliedParams.fastExternalSequenceParsing);
